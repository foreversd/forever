...
var getOptions = cli.getOptions = function (file) {
  ...
  [
    ...
    'silent', 'outFile', 'max', ,'plain', 'command', 'path', 'spinSleepTime',
    'sourceDir', 'uid', 'watchDirectory', 'debug', 'killTree', 'killSignal'
...
// Check if options are defined, works for plain and debug
//
function checkOptions() {
