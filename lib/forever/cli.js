...
var help = [
  ...
  '  --noUseIdleNotification        Disable NodeJS idle notification',
  '  --exposeGC                     Expose NodeJS garbage collector',
...
var argvOptions = cli.argvOptions = {
  ...
  'plain':     { boolean: true },
  'exposeGC': { boolean: false },
  'noUseIdleNotification': { boolean: false }
};
...
var getOptions = cli.getOptions = function (file) {
  ...
  [
    ...
    'silent', 'outFile', 'max', 'command', 'noUseIdleNotification', 'exposeGC', 'path', 'spinSleepTime', 
